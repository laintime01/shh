// 修复 src/app/api/side-hustles/[id]/route.ts
...
export async function GET(
  ...
  try {
    ...
    console.error('Get side hustle error:', err.message);
    return Response.json(
...
export async function PUT(
  ...
  try {
    ...
    const err = error as Error;
    console.error('Update side hustle error:', err.message);
    return Response.json(
...
export async function DELETE(
  ...
  try {
    ...
    const err = error as Error;
    console.error('Delete side hustle error:', err.message);
    return Response.json(
